...
//                MessageManager.FindProductionTaskBatch(BatchKinds.SGB);
        ...
        private void CloseShift()
        {
            ...
            using (var gammaBase = DB.GammaDb)
            {
                ...
                {
                    MessageBox.Show("Есть неподтвержденный рапорт, он будет открыт для редактирования",
                        "Неподтвержденный рапорт", MessageBoxButton.OK, MessageBoxImage.Information);
