					...
					case 0:
                        if (isSource1C)
                            ...
                            .Select(dc => new DocComplectationListItem
                            {
                                ...
                                PlaceId = WorkSession.Places.Any(p => p.C1CPlaceID == dc.C1CWarehouseID) ? WorkSession.Places.FirstOrDefault(p => p.C1CPlaceID == dc.C1CWarehouseID).PlaceID : gammaBase.Places1CWarehouses.FirstOrDefault(p => p.C1CWarehouseID == dc.C1CWarehouseID).PlaceID,
